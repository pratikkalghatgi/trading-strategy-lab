document.addEventListener("DOMContentLoaded", function () {
  ...
  function formatCompactCr(value) {
    if (!Number.isFinite(value)) return "-";
    if (value >= 10000000) return (value / 10000000).toFixed(2) + "M";
